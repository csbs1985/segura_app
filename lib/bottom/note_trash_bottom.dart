...
class NoteTrashBottom extends StatefulWidget {
  const NoteTrashBottom({
    super.key,
  ...
  @override
  State<NoteTrashBottom> createState() => _NoteTrashBottomState();
}

class _NoteTrashBottomState extends State<NoteTrashBottom> {
